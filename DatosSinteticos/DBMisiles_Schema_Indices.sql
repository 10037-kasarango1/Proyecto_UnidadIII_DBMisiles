...
nbr_ix_var_id_pieza    NUMBER NOT NULL
);
...
nbr_ix_var_id_com    NUMBER NOT NULL
);
...
nbr_ix_var_id_rol    NUMBER NOT NULL
);
...
nbr_ix_var_id_perm    NUMBER NOT NULL
);
...
nbr_ix_var_id_mis     NUMBER NOT NULL
);
...
nbr_ix_var_id_par    NUMBER NOT NULL
);
...
nbr_ix_var_id_dept    NUMBER NOT NULL
);
